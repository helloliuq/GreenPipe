...
<!-- CUSTOMIZE/OVERRIDE THE DEFAULT CSS -->
	...
	.ui-layout-east h4 { /* Footer in East-pane */
        ...
        var westLayout;
                $(document).ready( function() {
                        ...
                        // PAGE LAYOUT
                        $('body').layout({
                                west__size:                     $('body').innerWidth() * 0.15
                        ,       east__size:                     200
			...
			,	east__onresize:		'eastLayout.resizeAll'
                        ...
                        $('div.ui-layout-west').layout({
                                north__size:                     $('div.ui-layout-west').innerWidth() * 0.5
                        ,       center__size:                    100
                        ,       south__size:                    200
                        });
			...
			,	south__size:			200
                        ...
                        ,       center__spacing_closed: 10
                        ,       center__spacing_open: 10

		        });
                        westLayout.resizeContent("south");
                        westLayout.resizeContent("center");
	...
	$(document).ready( function() {
        ...
        //westLayout.resizeContainer("south");
        //westLayout.resizeContainer("center");
...
my.gadgetSpecUrls = [
"http://communicado.ci.uchicago.edu:8888/SIDGridGadgets/oops3.xml",
...
<div class="ui-layout-west">
	<div class="west-center">Inputs
                   <div id="gadget-chrome-2" class="gadgets-gadget-chrome"></div>
        </div>
	<div class="west-south">Workflows
