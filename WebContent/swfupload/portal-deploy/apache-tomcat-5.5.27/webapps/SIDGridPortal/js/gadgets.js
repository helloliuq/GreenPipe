...
gadgets.IfrGadgetService = function() {
  ...
  gadgets.rpc.register('selectTab', this.selectTab);
  gadgets.rpc.register('getCurWfDir', this.getCurWfDir);
};
...
gadgets.IfrGadgetService.prototype.selectTab = function(tabIndex) {
    var $tabs = $('#main_app_tabs').tabs();
...
var current_run_folder;
gadgets.IfrGadgetService.prototype.getCurWfDir = function(){
    if( current_run_folder == undefined ) return ""
...
gadgets.IfrGadget.prototype.getTitleBarContent = function(continuation) {
  continuation('<span id="' +
      this.getIframeId() + '_title" class="' +
      this.cssClassTitle + '">' + (this.title ? this.title : '') + '</span> <span class="' +
      ...
      '"></a> <a href="#" onclick="gadgets.container.getGadget(' +
...
gadgets.IfrGadget.prototype.getIframeUrl = function() {
  ...
  // turam: this is a hack, should be set by a call to setServerBase o.s.
