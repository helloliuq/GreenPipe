...
gadgets.IfrGadgetService = function() {
  ...
  gadgets.rpc.register('getParameters', this.getParameters);
...
/**
 * RPC functions for running science portal gadgets
 */
gadgets.IfrGadgetService.prototype.getParameters = function() {
  if (gadgets.container.dirname != undefined) {
    return gadgets.container.dirname;
  } else
    return 'not defined';
}
...
gadgets.IfrGadget = function(opt_params) {
  ...
  this.serverBase_ = 'http://sidgrid.ci.uchicago.edu:8888/gadgets/';
};
...
gadgets.Container = function() {
  ...
  this.parentUrl_ = 'http://shindig.serveftp.org/gadgets'; 
  this.country_ = 'ALL';
  this.language_ = 'ALL';
  this.view_ = 'default';
  this.nocache_ = 1;
...
gadgets.Container.prototype.remGadget = function(instanceId){
