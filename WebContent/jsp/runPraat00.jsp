...
<li>
    	  ...
    	  <textarea rows="7" cols="60" id="praat_inscript_data" name="praat_inscript_data" class="form_parameter mandatory"></textarea>
</li>
</ol>
</span>
</fieldset>
...
<li>
    	  or the actual data here:
    	  <textarea rows="7" cols="60" id="praat_infile_data" name="praat_infile_data" class="form_parameter mandatory"></textarea>
</li>
</ol>
</span>
</fieldset>
