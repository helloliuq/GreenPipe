...
//console.log("upload cancel")
   ...
   var upload = new SWFUpload({
                // Backend Settings
                upload_url: "/GreenPipe/fileupload?user=" + username,   // Relative to the SWF file (or you can use absolute paths)
...
upload_cancel_callback : 'uploadCancel',
            ...
            function createCommandLineApplication() {
                ...
                else
                {
                    ...
                    alert("4")
                    setTimeout("$(window.location).attr('href','../WireIt-0.5.0/examples/WiringEditor/index.html')",50000)
                }
            }
            ...
            function init() {
	            ...
	            jQuery(function() {
	            	...
	            	//alert("111")
	            	//alert("112")
                    jsonrpc = new JSONRpcClient("/GreenPipe/Old-JSONRPC");
	            	//alert("113")
     ...
     <!--  <%@ include file="nav.html" %> -->
      <div style="width:60%;margin-left:auto;margin-right:auto;padding:0px 20px;">
         <div id="buttonset" class="buttons" style="float:left">
            ...
            <input type="radio" id="swift-radio" onClick="setMode('swift')" /><label for="swift-radio">Program</label>
